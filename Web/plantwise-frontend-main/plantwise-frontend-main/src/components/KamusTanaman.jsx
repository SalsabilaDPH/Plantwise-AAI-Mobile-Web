...
import phoneMockup from '../assets/img/phone7.png';
import planIcon from '../assets/img/Vector3.png';
    ...
    style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <div className="container mx-auto flex flex-col justify-center items-center text-center lg:flex-row lg:text-left lg:items-center lg:space-x-12">
        ...
        <Link to="/" className="flex items-center space-x-3">
            ...
            <h1 className="text-4xl font-bold text-green-800">Kamus Tanaman</h1>
          </Link>

          <h3 className="text-2xl font-bold text-green-800">Panduan Lengkap untuk Perawatan 
            <br/>Tanamanmu!</h3>
          <p className="text-lg text-green-700">
          Informasi praktis tentang Tanaman Hias.
            </p>
          <div>
            <Link to="/Download">
